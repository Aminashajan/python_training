    ...
    if os.path.exists(DATA_FILE):
        with open(DATA_FILE, "r") as f:
            try:
                ...
                print("Warning: JSON file was empty orcorrupted. Starting fresh.")
                return {}
    else:
        return {}       
# ---------- Create account ----------
def create_account(data):
    ...
    data[name] = {"account_holder": name, "pin": pin,
    "balance": balance}
...
def delete_account(data):
    ...
    if name in data:
        confirm = input(f"Are you sure you want to deleteaccount '{name}'? (y/n): ").lower()
        if confirm == 'y':
            del data[name]
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            print("Invalid choice. Please enter a numberbetween 1-5.")
